...
show_usage() {
  ...
  echo "Options:"
  echo "  -r, --rate <RATE>         Set the attack rate of requests per second (e.g., '10'). Default: ${DEFAULT_EP_RATE}"
  echo "  -d, --duration <DURATION> Set the attack duration in seconds(e.g., '30'). Default: ${DEFAULT_EP_DURATION}"
