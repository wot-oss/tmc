	...
	tests := []struct {
		...
		},
		{
			...
			requests: []struct {
				...
				{"POST", "/thing-models/variations?tm-id=a-corp/eagle/bt2000/v1.0.0.tm.json&variant-id=a-corp/eagle/bt2000-special/v1.0.0.tm.json", []byte("{}"), http.StatusOK, true},
				{"POST", "/thing-models/variations?tm-id=a-corp/eagle/bt2000/v1.0.0.tm.json&variant-id=b-corp/frog/bt3000-special/v1.0.0.tm.json", []byte("{}"), http.StatusUnauthorized, false},
				{"POST", "/thing-models/variations?tm-id=b-corp/frog/bt3000/v1.0.0.tm.json&variant-id=b-corp/frog/bt3000-special/v1.0.0.tm.json", []byte("{}"), http.StatusUnauthorized, false},
