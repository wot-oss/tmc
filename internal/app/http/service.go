...
type HandlerService interface {
	ListInventory(ctx context.Context, repo string, search *model.Filters) (*model.SearchResult, error)
	SearchInventory(ctx context.Context, repo, query string) (*model.SearchResult, error)
	ListAuthors(ctx context.Context, search *model.Filters) ([]string, error)
	ListManufacturers(ctx context.Context, search *model.Filters) ([]string, error)
	ListMpns(ctx context.Context, search *model.Filters) ([]string, error)
...
func (dhs *defaultHandlerService) ListInventory(ctx context.Context, repo string, search *model.Filters) (*model.SearchResult, error) {
...
func (dhs *defaultHandlerService) ListAuthors(ctx context.Context, search *model.Filters) ([]string, error) {
	authors := []string{}
...
func (dhs *defaultHandlerService) ListManufacturers(ctx context.Context, search *model.Filters) ([]string, error) {
	mans := []string{}
...
func (dhs *defaultHandlerService) ListMpns(ctx context.Context, search *model.Filters) ([]string, error) {
	mpns := []string{}
